...
$id   = isset($_GET['id']) ? $_GET['id'] : header("location: ../dokter", true, 301);
$data = $koneksi->query("SELECT * FROM dokter WHERE id_dokter = '$id'")->fetch_array();
?>
                                ...
                                <form class="form-horizontal" action="proses" method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nip" id="nip" autocomplete="off" onkeypress="return Angkasaja(event)" maxlength="20" value="<?= $data['nip'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="poli" id="poli" autocomplete="off" maxlength="10" required value="<?= $data['poli'] ?>">
                                            </div>
                                        </div>
