...
$data = $koneksi->query("SELECT * FROM pemeriksaan pm INNER JOIN penerimaan p ON pm.id_penerimaan = p.id_penerimaan INNER JOIN nomor_antri n ON p.id_antri = n.id_antri WHERE pm.id_pemeriksaan = '$id'")->fetch_array();
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Data Pemeriksaan Pasien</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control select2" name="id_dokter" id="id_dokter" data-placeholder="Pilih" style="width: 100%;" required>
                                                    ...
                                                    ?>
                                                        <option value="<?= $item['id_dokter'] ?>" <?= $item['id_dokter'] == $data_dokter['id_dokter'] ? 'selected' : '' ?>><?= $item['nama'] ?> (Poli : <?= $item['poli'] ?>)</option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
